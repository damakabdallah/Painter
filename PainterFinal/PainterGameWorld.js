...
function PainterGameWorld() {
    ...
    this.can1 = new PaintCan(30, Color.red);
    this.can2 = new PaintCan(150, Color.green);
    this.can3 = new PaintCan(270, Color.blue);
...
PainterGameWorld.prototype.draw = function () {
    ...
    Canvas2D.drawImage(sprites.scorebar, new Vector2(10, 545));
    Canvas2D.drawText("Score: " + this.score, new Vector2(20, 550), Color.white);
    ...
    for (var i = 0; i < this.lives; i++) {
        Canvas2D.drawImage(sprites.lives, new Vector2(i * sprites.lives.width + 15, 490));
    }
    if (this.lives <= 0)
